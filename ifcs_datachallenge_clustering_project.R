...
## -------------------------------------------------------------
# Clustering - 1. Transform all to categorical - MCA
##---------------------------------------------------------------
...
## -------------------------------------------------------------
# Clustering - 2. MCA -Domain Clustering
##---------------------------------------------------------------
...
###### STEP1:   each domain fit MCA clustering ------------
...
matplot(t(vaslchange), type = c("b"),pch=1:8,col = 1:8, cex=0.5, ylab= "LBP Intensity", xlab ="Time Point")
legend("topright", legend =1:8, col=1:8, pch=1:8, cex = 0.5)
...
matplot(t(rmchange), type = c("b"),pch=1:8,col = 1:8, cex=0.5,ylab= "RMProp", xlab ="Time Point")
legend("topright", legend =1:8, col=1:8, pch=1:8, cex = 0.5)
...
matplot(t(genchange), type = c("b"),pch=1:8,col = 1:8, cex=0.5)
legend("topright", legend =1:8, col=1:8, pch=1:8, cex = 0.5)
